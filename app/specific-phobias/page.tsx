...
const SpecificPhobias: React.FC = () => {
  const information = [
  ...
  return (
    <div className="min-h-screen flex py-8 px-4 text-gray-200">
      <div className="max-w-4xl mx-auto w-full">
        ...
        The test assesses symptoms of different types of phobias
        such as immediate and intense fear, avoidance behaviors
...
export default SpecificPhobias;
