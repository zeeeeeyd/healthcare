    ...
    <div className="min-h-screen flex py-8 px-4 text-gray-200">
      <div className="max-w-4xl mx-auto w-full">
        ...
        <p className="leading-relaxed text-lg text-justify mb-6">
          This test assesses the symptoms of general anxiety disorder experienced by the patient such as catastrophic
          thinking, avoidance behavior, undue fear, pre-emption of events and exaggeration, inability to relax, difficulty
          concentrating, and physiological symptoms.
        </p>
